...
public class Algorithm extends Knowledge {
    ...
    public Algorithm(String name, String content, Agent.KClasses kclass, Concept input, Concept output, ArrayList<String> outputs, ArrayList<String> actions, ArrayList<Object> parameters, ArrayList<GenState> train_states) {
